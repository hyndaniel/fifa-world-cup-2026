...
const MATCHES = [
  { num: '101', home: '法国', away: '西班牙', home_en: 'France', away_en: 'Spain',
    ko: 'SF1(半决赛) · ET 7/14 15:00(达拉斯当地 14:00 CT)/ 北京 7/15 03:00 · 得州阿灵顿 AT&T Stadium(赛事名 Dallas Stadium,可开合顶棚)中立场 · 当天是法国国庆巴士底日'
      + ' 🔴【本轮=增量复核,距开球仅 12 小时,官宣首发窗已近(约赛前 1h)】上一轮情报(7/13)已确证并落库的事实**不必重复挖**:姆巴佩踝伤已恢复合练可首发、楚阿梅尼伤愈可用(首发存疑)、萨利巴+于帕梅卡诺 7/11 双双缺训但预计首发、西班牙首发零伤号、尼科·威廉姆斯可用但预计替补、两队零停赛(黄牌 QF 后已清零)、主裁 Iván Barton(萨尔瓦多)。'
      + ' **本轮只找「7/13 之后的新变化」**:① 官宣/接近官宣的首发 XI(尤其法国双后腰 楚阿梅尼 vs 科内 谁首发、西班牙中场第三人 法比安/佩德里/梅里诺);② 萨利巴/于帕梅卡诺是否真的恢复训练、有无新伤讯;③ 赛前最后一堂训练/发布会的新料;④ VAR/AVAR 是否公布;⑤ 任何推翻上轮结论的新事实。' },
  { num: '102', home: '英格兰', away: '阿根廷', home_en: 'England', away_en: 'Argentina',
    ko: 'SF2(半决赛) · ET 7/15 15:00 / 北京 7/16 03:00 · 亚特兰大 Mercedes-Benz Stadium(赛事名 Atlanta Stadium,顶棚本届全程关闭)中立场 · 英阿世界杯正赛自 2002 年后首次相遇'
      + ' 🔴【本轮=增量复核,距开球 36 小时】上一轮情报(7/13)已确证并落库的事实**不必重复挖**:Quansah 红牌 2 场禁赛、本场确定停赛缺阵(⚠️多家聚合站误写成 Konsa 停赛,实为 Quansah);Konsa 只是抽筋、可用;赖斯肠胃炎是 QF 对挪威的旧事、已降 minor doubt;亨德森腕伤留队但出场概率极低;梅西眼部划伤无碍、健康首发;Romero/Paredes 抽筋非结构伤;两队零累计黄风险(单黄两次清零)。'
      + ' **本轮只找「7/13 之后的新变化」**:① 🔴 **主裁已公布 = Ismail Elfath(美籍)** —— 请核实并补全其执法数据(本届场次/牌数尺度)+ 助理/VAR/AVAR 名单;② Romero 体能与是否首发、Medina 伤情是否终于有一手确证(上轮该条前后矛盾、判为存疑);③ 英格兰右后卫三选一(里斯·詹姆斯/斯彭斯/孔萨)与萨卡是否夺回首发;④ 两队赛前训练/发布会新料;⑤ 任何推翻上轮结论的新事实。' },
]
