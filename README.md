...
tools/     每日工具 (odds_watch / v2_report / save_intel / poly_fetch_hk / odds_consensus / refresh_all / backfill_results ...)
reports/   产出 md (小组赛比分预测 / 盘口下注复盘 / 预测v2 / 复盘对错标 / deep-search-*)
...
v1 后端/前端 + v2 概率脑 + 三方 Brier 跑分 + 赛果自动回填闭环（launchd 每5min,跑分卡 n>0）+ 一键编排 + 决策卡看板均已落地。
